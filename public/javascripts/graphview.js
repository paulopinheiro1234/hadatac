...
var data = JSON.parse(query_res.dataset.results);
...
var config = {
    ...
    "types" : {
        ...
        "deployment"       : {
            "short" : "Deployment",
            "long"  : "Instrument Deployment at Platform"
        },
        "sdd"       : {
            "short" : "SDD",
            "long"  : "Semantic Data Dictionary"
        },
        "variable"       : {
            "short" : "Variable",
            "long"  : "Scientific Variable"
        },
        "daspec"       : {
            "short" : "DA Spec",
            "long"  : "Data Acquisition Specification"
        },
        "soc"        : {
            "short" : "SOC",
            "long"  : "Semantic Object Collection"
        },
    },
    "constraints" : [
        {
...
$(function() {
    ...
    d3.json(config.jsonUrl, function() {
...
function drawGraph() {
    ...
    function getColorScale(darkness) {
        return d3.scale.ordinal()
		    .domain(["property:", "object:", "study:",  "deployment:", "sdd:",    "variable:", "daspec:" , "ontology:", "soc:"])
    		.range( ["#ffffb3",   "#fdd2ce", "#faaaff", "#ffa3ad",     "#accfef", "#d5e8ce",   "#ddc1b3",  "#f7c388", "#30fff4", "#bc80bd", "#d9d9d9", "#ffed6f"]);
    		//.range(["#fb8072", "#ffffb3", "#bebada", "#8dd3c7", "#80b1d3", "#fdb462", "#b3de69", "#fccde5", "#d9d9d9", "#bc80bd", "#ccebc5", "#ffed6f"]);
...
function resize(showDocs) {
    ...
    $close.css({
        ...
        right : window.innerWidth - 800 + docsClosePadding + 'px'
    });
