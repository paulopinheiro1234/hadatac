...
SET SOLR4_HOME=%HADATAC_SOLR%\solr-4.10.4
...
wget -O %HADATAC_DOWNLOAD%\solr-4.10.4.zip http://archive.apache.org/dist/lucene/solr/4.10.4/solr-4.10.4.zip
wget -O %HADATAC_DOWNLOAD%\solr-4.10.4.zip.md5 http://archive.apache.org/dist/lucene/solr/4.10.4/solr-4.10.4.zip.md5
...
winrar x %HADATAC_DOWNLOAD%\solr-4.10.4.zip *.* %HADATAC_SOLR%
...
copy /b %HADATAC_SOLR%\hadatac_solr.bat+%HADATAC_SOLR%\solr4.in.bat %HADATAC_SOLR%\solr4.in.bat
...
%HADATAC_SOLR%\run_solr4.bat start
...
%HADATAC_SOLR%\run_solr4.bat restart
