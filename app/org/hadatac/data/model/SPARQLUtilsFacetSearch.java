...
public class SPARQLUtilsFacetSearch {
    ...
    private static AcquisitionQueryResult initialResponse = null;
    ...
    public static AcquisitionQueryResult createInitialResponse(DatabaseExecutionContext databaseExecutionContext) {
        try {
            if (databaseExecutionContext == null) {
                System.out.println("[ERROR] Database context is NULL");
            }
            CompletableFuture<AcquisitionQueryResult> promiseOfInitialResponse = CompletableFuture.supplyAsync((
                    () -> {
                        return Measurement.createInitialResponse(databaseExecutionContext);
                    }
            ), databaseExecutionContext);
            initialResponse = promiseOfInitialResponse.get();
    ...
    public static AcquisitionQueryResult getInitialResponse() {
        return initialResponse;
    }
