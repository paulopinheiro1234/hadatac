...
//    }
//
//    protected Mailer.Mail.Body getPasswordResetMailingBody(final String token,
//                                                           final SysUser user, final Http.Request request) {
//
//        final boolean isSecure = getConfiguration().getBoolean(Constants.SETTING_KEY_PASSWORD_RESET_LINK_SECURE);
...
////} {
//
//    private static final String SETTING_KEY_VERIFICATION_LINK_SECURE = "mail"
//            + "." + "verificationLink.secure";
//    private static final String SETTING_KEY_PASSWORD_RESET_LINK_SECURE = "mail"
...
////    @Override
////    protected String signupUser(final MyUsernamePasswordAuthUser authUser) {
////
...
////        final SysUser newUser = SysUser.create(authUser, "");
...
////            return "USER_CREATED";
////        }
////        return "USER_CREATED_UNVERIFIED";
////    }
////TODO -- never used delete
//////    @Override
...
//        return this.messagesApi.preferred(request.acceptLanguages()).at(
...
//                                                             final Http.Request request) {
//        return this.messagesApi.preferred(request.acceptLanguages()).at(
//                "Confirm your e-mail addressConfirm your e-mail address");
//    }
//
...
//        return mailer.sendMail(mail); //TODO : mailer should be initialized
//    }
//
//}
