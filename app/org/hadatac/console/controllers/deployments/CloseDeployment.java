...
public class CloseDeployment extends Controller {
    ...
    public Result index(String deployment_uri, Http.Request request) {
        ...
        if (!deployment_uri.equals("")) {
            ...
            return ok(closeDeployment.render(deployment_uri, depForm, application.getUserEmail(request)));
        }
    ...
    public Result processForm(String deployment_uri, Http.Request request) {
        ...
        if (form.hasErrors()) {
            ...
            return ok(deploymentConfirm.render("Close Deployment", data, "/", "", "", 0,application.getUserEmail(request)));
        }
    }
}
