...
public class Alkaloids extends Controller {
    ...
    public static Result index() {
        ...
        String tabName = "Alkaloids";
        String query_json = null;
        System.out.println("Alkaloids.java is requesting: " + tabName);
        try {
        ...
        System.out.println("Alkaloids index() was called!");
    	
    	//List<org.hadatac.entity.pojo.Entity> entities = org.hadatac.entity.pojo.Entity.find();
    	
        return ok(analytes_browser.render(theResults, "Alkaloids"));
    }// /index()
