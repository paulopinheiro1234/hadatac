...
public class BirthOutcomes extends Controller {
    ...
    public static Result index() {
        ...
        String tabName = "BirthOutcomes";
        String query_json = null;
        System.out.println("BirthOutcomes.java is requesting: " + tabName);
        try {
        ...
        System.out.println("BirthOutcomes index() was called!");
    	
    	//List<org.hadatac.entity.pojo.Entity> entities = org.hadatac.entity.pojo.Entity.find();
    	
        return ok(metaclasses_browser.render(theResults, "BirthOutcomes"));
    }// /index()
