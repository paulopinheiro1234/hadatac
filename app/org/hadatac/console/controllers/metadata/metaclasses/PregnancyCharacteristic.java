...
public class PregnancyCharacteristic extends Controller {
    ...
    public static Result index() {
        ...
        String tabName = "PregnancyCharacteristic";
        String query_json = null;
        System.out.println("PregnancyCharacteristic.java is requesting: " + tabName);
        try {
        ...
        System.out.println("PregnancyCharacteristic index() was called!");
    	
    	//List<org.hadatac.entity.pojo.Entity> entities = org.hadatac.entity.pojo.Entity.find();
    	
        return ok(metaclasses_browser.render(theResults, "PregnancyCharacteristic"));
    }// /index()
