...
public class ATIDU extends Controller {
    ...
    public static Result index() {
        ...
        String tabName = "ATIDU";
        String query_json = null;
        System.out.println("ATIDU.java is requesting: " + tabName);
        try {
        ...
        System.out.println("ATIDU index() was called!");
    	
    	//List<org.hadatac.entity.pojo.Entity> entities = org.hadatac.entity.pojo.Entity.find();
    	
        return ok(metaclasses_browser.render(theResults, "ATIDU"));
    }// /index()
