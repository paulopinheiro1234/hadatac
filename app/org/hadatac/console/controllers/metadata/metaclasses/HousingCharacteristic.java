...
public class HousingCharacteristic extends Controller {
    ...
    public static Result index() {
        ...
        String tabName = "HousingCharacteristic";
        String query_json = null;
        System.out.println("HousingCharacteristic.java is requesting: " + tabName);
        try {
        ...
        System.out.println("HousingCharacteristic index() was called!");
    	
    	//List<org.hadatac.entity.pojo.Entity> entities = org.hadatac.entity.pojo.Entity.find();
    	
        return ok(metaclasses_browser.render(theResults, "HousingCharacteristic"));
    }// /index()
