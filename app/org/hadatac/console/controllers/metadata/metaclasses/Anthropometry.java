...
public class Anthropometry extends Controller {
    ...
    public static Result index() {
        ...
        String tabName = "Anthropometry";
        String query_json = null;
        System.out.println("Anthropometry.java is requesting: " + tabName);
        try {
        ...
        System.out.println("Anthropometry index() was called!");
    	
    	//List<org.hadatac.entity.pojo.Entity> entities = org.hadatac.entity.pojo.Entity.find();
    	
        return ok(metaclasses_browser.render(theResults, "Anthropometry"));
    }// /index()
